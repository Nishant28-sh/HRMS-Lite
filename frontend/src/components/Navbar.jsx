      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2 md:space-x-3">
            ...
            <div>
              <h1 className="text-lg md:text-2xl font-bold tracking-tight">HRMS Lite</h1>
              <p className="text-xs md:text-sm text-blue-100 hidden sm:block">Human Resource Management System</p>
            </div>
          </div>
          <div className="flex items-center space-x-2 md:space-x-4">
            <div className="text-right hidden xs:block">
              <p className="text-xs md:text-sm text-blue-100">Welcome, Admin</p>
